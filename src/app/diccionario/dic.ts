export const diccionario = {
    home: {
        title:'Favor de pagar',
        amigosComoGiles:'amigos'
    },
    app:{
        ...
        errorGasto:'Ups! Hay un problema con el gasto que queres agregar, recorda que:',
        toastDeleteGilMsg:'Que la fuerza te acompanie ',
        toastDeleteGilTitle:'Se quito correctamente',
        infoToastAgregar: 'Se agrego el gasto de ',
        graciasInfoToast:'Gracias por tu aporte '
    }
